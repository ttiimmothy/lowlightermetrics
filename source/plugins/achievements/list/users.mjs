...
export default async function({list, login, data, computed, imports, graphql, queries, rest, rank, leaderboard}) {
  ...
  const requirements = {stars: 1, followers: 1, forks: 0, created: 1}
  ...
  //Contributor
  {
    ...
    list.push({
      ...
      ...rank(value, [1, 200, 500, 1000, 20000]),
      value,
      unlock: new Date(unlock?.createdAt),
    })
  }
  ...
  //Stargazer
  {
    ...
    list.push({
      ...
      ...rank(value, [0, 200, 500, 900, 10000]),
      value,
      unlock: new Date(unlock?.createdAt),
    })
  }
  ...
  //Influencer
  {
    ...
    list.push({
      ...
      ...rank(value, [0, 0, 200, 1000, 500000]),
      value,
      unlock: new Date(unlock?.createdAt),
  ...
  //Maintainer
  {
    ...
    list.push({
      ...
      ...rank(value, [0, 1, 1000, 5000, 1000000]),
      value,
      unlock: new Date(unlock?.createdAt),
  ...
  //Deployer
  {
    ...
    list.push({
      ...
      ...rank(value, [0, 200, 500, 1000, 20000]),
      value,
      unlock: new Date(unlock?.createdAt),
    })
  }
  ...
  //Chatter
  {
    ...
    list.push({
      ...
      ...rank(value, [0, 200, 500, 1000, 3000]),
      value,
      unlock: new Date(unlock?.createdAt),
    })
  }
