...
See [rendering of this file here](https://github.com/actionhooks/lowlightermetrics/blob/examples/metrics.markdown.full.md) and [original template source here](https://github.com/actionhooks/lowlightermetrics/blob/master/source/templates/markdown/example.md).
